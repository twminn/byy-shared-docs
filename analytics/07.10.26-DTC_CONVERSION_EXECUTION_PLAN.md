...
| D3 | Tour-first CTA + canonical stats PR | [byy-landing-pages#8](https://github.com/twminn/byy-landing-pages/pull/8) — **open, not merged/deployed** |
...
|---|------|-------|----------------|--------|
| N1 | **Merge + deploy LP PR #8** (`new` + main hero) | Frontend | `byy-landing-pages` | Open |
